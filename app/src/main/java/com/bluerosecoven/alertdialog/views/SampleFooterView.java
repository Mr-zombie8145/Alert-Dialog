package com.bluerosecoven.alertdialog.views;
...
import com.bluerosecoven.alertdialog.R;
import com.bluerosecoven.cfalertdialog.views.CFPushButton;
...
public class SampleFooterView extends LinearLayout implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view == null) {
            ...
            } else if (view.getId() == R.id.header_toggle_button) {
                toggleHeaderState((HeaderState) headerToggleButton.getTag());
            } else if (view.getId() == R.id.configuration_toggle_button) {
                toggleState();
            } else {
                return;
            }
